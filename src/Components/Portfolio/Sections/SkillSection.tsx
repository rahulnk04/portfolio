    ...
    >
      ...
      >
        <Box sx={{ maxWidth: 1120, mx: "auto", px: { xs: 4, md: 2 } }}>
          ...
          >
            Core competencies categorized so you can quickly scan what powers
            the experience and systems I build. Proficiency is shown with both a
            percentage and a visual bar.
          </Typography>

          <Grid container spacing={4} columns={{ xs: 4, sm: 8, md: 12 }}>
            {Object.entries(skills).map(
              ([category, skillList]: [string, Skill[]], idx: number) => {
